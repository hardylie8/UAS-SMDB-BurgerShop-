        ...
        <div class="box1">
            <table>
                ...
                while ($d = mysqli_fetch_array($data)) {
                    $idMenu = $d['IdMenu'];
                    $data1 = mysqli_query($koneksi, "SELECT *  from menu where IdMenu = '$idMenu' ");
                    $d1 = mysqli_fetch_array($data1);    
                    echo "<tr>";

                ?>
                        <td><?php echo $i ?></td>
                        <td><img src="<?php echo $d1['Gambar']  ?>" alt=""></td>
                        <td><?php echo $d1['NamaMenu']  ?> </td>
                        <td><?php echo $d['qty'] ?></td>
                        
                        <td><?php echo $d1['Harga'] ?>K </td>
                        <td><?php echo $d1['Harga']*$d['qty']  ?>K </td>
                    <?php
                         echo "</tr>";
                         $i++;
                    }
    ...
    <div class="box2">
        ...
        <form class="pay" >
            <div class="item">
                ...
                <input type="text" name="qty" readonly value=" <?php echo  $d['qty']?>">
            </div>
            <div class="item">
                <label for="">
                    Total Harga
                </label>
                <input type="text" name="totalHarga" readonly value=" <?php echo  $d['totalHarga'] ?>k">
            </div>
            <div class="item">
                <label for="">
                    Pajak(10%)
                </label>
                <input type="text" readonly value=" <?php echo  $d['totalHarga'] * 0.1 ?>k">
            </div>
            <div class="item">
                <label for="">
                    SubTotal
                </label>
                <input type="text" readonly name="subTotal" value=" <?php echo  $d['SubTotal'] ?>k">
            </div>
